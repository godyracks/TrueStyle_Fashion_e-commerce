<?php
// Include your database connection here (e.g., db.php)
...
if ($check_result && mysqli_num_rows($check_result) > 0) {
    ...
    $_SESSION['cart_message_class'] = 'success';
            ...
            // Use a session identifier as the guest_id (you may need to adjust this logic)
...
if (isset($_GET['remove'])) {
    ...
    if ($user_id) {
        ...
        $remove_query = "DELETE FROM guest_cart WHERE id = '$remove_id' AND session_id = '$session_id'";
    }
