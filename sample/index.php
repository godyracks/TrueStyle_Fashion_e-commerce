...
if (isset($_POST['order_btn'])) {
    ...
    $insert_order_query = mysqli_prepare($conn, "INSERT INTO `orders` (user_id, name, email, address, city, zip, payment_method, total_products, total_price, order_time) 
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, CURRENT_TIMESTAMP)");

    mysqli_stmt_bind_param($insert_order_query, "ssssssssd", $user_id, $name, $email, $address, $city, $zip, $payment_method, $total_products, $grand_total);
...
<body>
    <div class="container4">
        ...
        <div class="order-summary">
            ...
            <!-- Repeat the above order item for each product in the cart -->
            <div class="total">
                <p>Total: $21.98</p>
            </div>
        </div>
